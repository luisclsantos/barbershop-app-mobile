...
class PortfolioBaberCutsSection extends StatefulWidget {
  const PortfolioBaberCutsSection({Key? key}) : super(key: key);

  @override
  State<PortfolioBaberCutsSection> createState() =>
      _PortfolioBaberCutsSectionState();
}

class _PortfolioBaberCutsSectionState
    extends ModularState<PortfolioBaberCutsSection, PortfolioStore> {
  @override
              ...
              children: [
                ...List.generate(
                  ...
                  (index) {
                    ...
                    if (model.type == kPortfolioBaberCutsTypeConstant) {
